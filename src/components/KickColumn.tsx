    ...
    <div className="w-full h-full flex flex-col justify-between items-center bg-zinc-900/60 border border-zinc-800/80 rounded-3xl p-5 xl:p-6 shadow-xl backdrop-blur-md relative overflow-hidden min-h-0">
      ...
      <div className="w-full shrink-0">
        <button
          ...
          className={`w-full py-3.5 px-4 font-bold text-xs uppercase tracking-wider rounded-xl transition-all duration-150 cursor-pointer hover:scale-[0.985] active:scale-[0.95] ${
            currentPlayer.cannotVote
              ? "bg-zinc-800/50 border border-zinc-800 text-zinc-500 cursor-not-allowed hover:scale-100"
              : hasVoted
